...
const page = usePage();
const user = page.props.auth?.user || { name: 'Candidate', email: '' };
        ...
        <nav class="bg-white dark:bg-card  border-b dark:border-border">
                    ...
                    <div class="flex items-center space-x-3">
                        ...
                        <div class="hidden lg:flex items-center space-x-6 ml-8">
                            <Link 
                                ...
                                :class="isActive('/candidate/dashboard') ? 'text-purple-600 dark:text-primary' : 'text-gray-700 dark:text-gray-300 hover:text-purple-600 dark:hover:text-primary'"
                            ...
                            <Link 
                                ...
                                :class="isActive('/candidate/profile') ? 'text-purple-600 dark:text-primary' : 'text-gray-700 dark:text-gray-300 hover:text-purple-600 dark:hover:text-primary'"
                                class="text-sm font-medium transition"
                            >
                                Profile
                            </Link>
            ...
            >
                <div class="px-4 py-3 space-y-1">
                    <Link 
                        href="/candidate/dashboard" 
                        :class="isActive('/candidate/dashboard') ? 'text-purple-600 dark:text-primary bg-purple-50 dark:bg-primary/10' : 'text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-accent'"
                    ...
                    <Link 
                        href="/candidate/profile" 
                        :class="isActive('/candidate/profile') ? 'text-purple-600 dark:text-primary bg-purple-50 dark:bg-primary/10' : 'text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-accent'"
                        class="block px-3 py-2 rounded-md text-sm font-medium transition"
                        @click="closeMobileMenu"
                    >
                        Profile
                    ...
                    <Link 
                        href="/candidate/announcements" 
                        :class="isActive('/candidate/announcements') ? 'text-purple-600 dark:text-primary bg-purple-50 dark:bg-primary/10' : 'text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-accent'"
                        class="block px-3 py-2 rounded-md text-sm font-medium transition"
                        @click="closeMobileMenu"
                    >
                        Announcements
                    ...
                    <Link 
                        href="/candidate/results" 
                        :class="isActive('/candidate/results') ? 'text-purple-600 dark:text-primary bg-purple-50 dark:bg-primary/10' : 'text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-accent'"
                        class="block px-3 py-2 rounded-md text-sm font-medium transition"
                        @click="closeMobileMenu"
                    >
                        Results
