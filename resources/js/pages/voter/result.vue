            ...
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6 md:py-8 min-h-[calc(100vh-64px)]">
                ...
                <div v-if="!selectedElection" class="flex items-center justify-center min-h-[60vh]">
                    <div class="text-center bg-white dark:bg-card border dark:border-border p-10 md:p-20 rounded-3xl shadow-sm max-w-lg w-full">
                        ...
                        <p class="text-sm text-gray-500 dark:text-muted-foreground mb-8">There are no election results to display at the moment.</p>
                ...
                <template v-else>
                    ...
                    <div v-if="statistics" class="grid grid-cols-2 md:grid-cols-4 gap-4 mb-8">
                        <div class="bg-white dark:bg-card p-4 rounded-2xl border dark:border-border shadow-sm">
                            <p class="text-[10px] font-bold text-gray-400 uppercase tracking-widest mb-1">Total Turnout</p>
                        ...
                        <div class="bg-white dark:bg-card p-4 rounded-2xl border dark:border-border shadow-sm">
                            <p class="text-[10px] font-bold text-gray-400 uppercase tracking-widest mb-1">Voters Cast</p>
                            ...
                            <div class="flex items-center gap-1.5 mt-2">
                                ...
                                <span class="text-[10px] text-gray-500 font-medium">Verified Students</span>
                            </div>
                        </div>
                        <div class="bg-white dark:bg-card p-4 rounded-2xl border dark:border-border shadow-sm">
                            ...
                            <div class="flex items-center gap-1.5 mt-2">
                                ...
                                <span class="text-[10px] text-gray-500 font-medium">Electoral Roles</span>
                            </div>
                        </div>
                        <div class="bg-white dark:bg-card p-4 rounded-2xl border dark:border-border shadow-sm">
                            <p class="text-[10px] font-bold text-gray-400 uppercase tracking-widest mb-1">Candidates</p>
                            ...
                            <div class="flex items-center gap-1.5 mt-2">
                                ...
                                <span class="text-[10px] text-gray-500 font-medium">Active Runners</span>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="divide-y divide-gray-100 dark:divide-border">
                                ...
                                >
                                    ...
                                    <div class="relative flex items-center gap-4 px-4 md:px-8 py-5">
                                        ...
                                        <!-- Avatar -->
                                        <img 
                                            :src="candidate.photo || '/images/profile.png'" 
                                            class="h-10 w-10 md:h-12 md:w-12 rounded-full object-cover border-2 border-white dark:border-card shadow-sm" 
                                            :alt="candidate.name"
                                        />
